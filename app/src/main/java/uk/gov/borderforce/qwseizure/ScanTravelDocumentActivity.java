 ...
 */
public class ScanTravelDocumentActivity extends AppCompatActivity {
    public static final String TAG = "STDA";
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_travel_document);

        mVisible = true;
        mControlsView = findViewById(R.id.fullscreen_content_controls);
        mContentView = findViewById(R.id.mrz_view);
        ...
        mrzScanView.setConfigFromAsset("mrz_scan_config.json");
...
// initialize Anyline with your license key and a Listener that is called if a result is found
        mrzScanView.initAnyline(getString(R.string.anyline_license_key), new MrzResultListener() {
            ...
            public void onResult(Identification mrzResult, AnylineImage anylineImage) {
                ...
                Log.d(TAG, "fond a result" + mrzResult.getDayOfBirth() + mrzResult.toJSONObject().toString());
                Intent intent = new Intent();
                intent.putExtra("MRTZ", mrzResult.toJSONObject().toString());
